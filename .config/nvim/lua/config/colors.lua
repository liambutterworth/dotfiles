...
highlight('Identifier', { fg=colors.brwhite })
...
highlight('StatusLineIsRecording', { bg=colors.red, fg=colors.white, bold=true })
...
highlight('TablineInactive', { bg=colors.none, fg=colors.brblack })
...
highlight('@variable', { fg=colors.brwhite })
