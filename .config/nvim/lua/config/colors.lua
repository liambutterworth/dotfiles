...
highlight('Comment', { fg = colors.bright_black })
...
highlight('Normal', { bg = colors.none, fg = colors.bright_white })
...
highlight('SpecialKey', { fg = colors.white })
highlight('SpecialChar', { fg = colors.white })
...
highlight('String', { fg = colors.green, bold = true })
...
highlight('Visual', { bg = colors.yellow, fg = colors.black, bold = true })
...
-- Git Signs
highlight('GitSignsAdd', { bg = colors.none, fg = colors.green })
highlight('GitSignsChange', { bg = colors.none, fg = colors.yellow })
highlight('GitSignsDelete', { bg = colors.none, fg = colors.red })

-- Status Line
highlight('StatusLine', { bg = colors.none, fg = colors.bright_white, bold = true })
highlight('StatusLineNC', { bg = colors.none, fg = colors.bright_white })
highlight('StatusLineHasErrors', { bg = colors.none, fg = colors.bright_red })
highlight('StatusLineHasInformation', { bg = colors.none, fg = colors.bright_blue })
highlight('StatusLineHasWarnings', { bg = colors.none, fg = colors.bright_yellow })
highlight('StatusLineIsRecording', { bg = colors.red, fg = colors.bright_white })
highlight('StatusLineOperator', { bg = colors.none, fg = colors.blue })
...
highlight('StatusLineInactive', { bg = colors.bright_white, fg = colors.black })
highlight('StatusLineModified', { bg = colors.bright_yellow, fg = colors.black })
highlight('StatusLineUnmodified', { bg = colors.bright_green, fg = colors.black })
highlight('StatusLineReadOnly', { bg = colors.red, fg = colors.black })

-- Tab Line
highlight('TabLine', { bg = colors.none, fg = colors.white })
highlight('TabLineActive', { bg = colors.none, fg = colors.white })
highlight('TabLineInactive', { bg = colors.none, fg = colors.bright_black })
...
highlight('TabLineModified', { bg = colors.none, fg = colors.yellow })
highlight('TabLineReadOnly', { bg = colors.none, fg = colors.red })
highlight('TabLineUnmodified', { bg = colors.none, fg = colors.green })

-- Telescope
highlight('TelescopeMatching', { fg = colors.red, bold = true })
highlight('TelescopeMultiSelection', { fg = colors.magenta })
highlight('TelescopeNormal', { fg = colors.bright_white })
...
highlight('TelescopeResultsDiffDelete', { bg = colors.none, fg = colors.red })
highlight('TelescopeResultsDiffUntracked', { bg = colors.none, fg = colors.red })
...
highlight('TelescopeSelection', { bg = colors.none, fg = colors.bright_white, bold = true })
highlight('TelescopeSelectionCaret', { bg = colors.none, fg = colors.magenta, bold = true })

-- Treesitter
highlight('@boolean', { fg = colors.bright_magenta })
highlight('@constant', { fg = colors.cyan })
highlight('@constant.builtin', { fg = colors.blue })
highlight('@constructor', { fg = colors.bright_white })
highlight('@function', { fg = colors.bright_cyan })
highlight('@function.builtin', { fg = colors.bright_cyan })
highlight('@function.call', { fg = colors.bright_cyan })
...
highlight('@punctuation.bracket', { fg = colors.bright_white })
highlight('@punctuation.delimiter', { fg = colors.bright_white })
...
highlight('@variable.builtin', { fg = colors.white })
highlight('@variable.member', { fg = colors.white })
highlight('@variable', { fg = colors.white })

-- Fish
highlight('fishOperator', { fg = colors.bright_white })
highlight('fishOption', { fg = colors.bright_white })
highlight('fishVariable', { fg = colors.yellow })
