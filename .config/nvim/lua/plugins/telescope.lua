return {
    ...
    config = function()
        ...
        vim.keymap.set('n', '<space><cr>', '<cmd>Telescope find_files cwd=%:p:h<cr>')
        vim.keymap.set('n', '<space><bs>', '<cmd>Telescope buffers<cr>')
        vim.keymap.set('n', '<space>\\', '<cmd>Telescope resume<cr>')
        vim.keymap.set('n', '<space>[', '<cmd>Telescope file_browser<cr>')
        vim.keymap.set('n', '<space>]', '<cmd>Telescope file_browser path=%:p:h select_buffer=true<cr>')
        ...
        vim.keymap.set('n', '<space>,', '<cmd>Telescope grep_string<cr>')
        ...
        vim.keymap.set('n', '<cr><cr>', '<cmd>Telescope git_files<cr>')
        vim.keymap.set('n', '<cr>s', '<cmd>Telescope git_status<cr>')
        vim.keymap.set('n', '<cr>t', '<cmd>Telescope git_stash<cr>')
        vim.keymap.set('n', '<cr>b', '<cmd>Telescope git_branches<cr>')
        vim.keymap.set('n', '<cr>c', '<cmd>Telescope git_commits<cr>')
    end,
}
