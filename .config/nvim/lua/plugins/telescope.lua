return {
    ...
    config = function()
        ...
        vim.keymap.set('n', '<leader><tab>', '<cmd>Telescope file_browser path=%:p:h select_buffer=true<cr>')
        vim.keymap.set('n', '<leader><cr>', '<cmd>Telescope file_browser<cr>')
        ...
        vim.keymap.set('n', '<leader>.', '<cmd>Telescope live_grep search_dirs=%:h<cr>')
        vim.keymap.set('n', '<leader>,', '<cmd>Telescope live_grep grep_open_files=true<cr>')
        vim.keymap.set('n', '<leader>+', '<cmd>Telescope git_status<cr>')
        vim.keymap.set('n', '<leader>=', '<cmd>Telescope git_branches<cr>')
        vim.keymap.set('n', '<leader>-', '<cmd>Telescope git_commits<cr>')
        vim.keymap.set('n', '<leader>_', '<cmd>Telescope git_bcommits<cr>')
    end,
}
